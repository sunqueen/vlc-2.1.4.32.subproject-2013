...
xml_t *xml_Create( vlc_object_t *p_this )
{
    ...
    p_xml = (xml_t *)vlc_custom_create( p_this, sizeof( *p_xml ), "xml" );			// sunqueen modify
...
xml_reader_t *xml_ReaderCreate(vlc_object_t *obj, stream_t *stream)
{
    ...
    reader = (xml_reader_t *)vlc_custom_create(obj, sizeof(*reader), "xml reader");			// sunqueen modify
