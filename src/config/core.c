                             ...
                             int64_t **restrict values, char ***restrict texts)
{
    ...
    *texts = NULL;
    ...
    int64_t *vals = (int64_t *)xmalloc (sizeof (*vals) * count);			// sunqueen modify
    char **txts = (char **)xmalloc (sizeof (*txts) * count);			// sunqueen modify
                                   ...
                                   char ***restrict texts)
{
    ...
    char **vals = (char **)xmalloc ((n + 2) * sizeof (*vals));			// sunqueen modify
    char **txts = (char **)xmalloc ((n + 2) * sizeof (*txts));			// sunqueen modify
                              ...
                              char ***restrict values, char ***restrict texts)
{
    *values = *texts = NULL;
    ...
    char **vals = (char **)xmalloc (sizeof (*vals) * count);			// sunqueen modify
    char **txts = (char **)xmalloc (sizeof (*txts) * count);			// sunqueen modify
...
{
    const module_config_t *const *ca = (const module_config_t *const *)a, *const *cb = (const module_config_t *const *)b;				// sunqueen modify
...
{
    const module_config_t *const *conf = (const module_config_t *const *)elem;				// sunqueen modify

    return (int)strcmp ((const char *)key, (*conf)->psz_name);				// sunqueen modify
}
...
int config_SortConfig (void)
{
    ...
    module_config_t **clist = (module_config_t **)malloc (sizeof (*clist) * nconf);				// sunqueen modify
...
module_config_t *config_FindConfig (vlc_object_t *p_this, const char *name)
{
    ...
    p = (module_config_t *const *)bsearch (name, config.list, config.count, sizeof (*p), confnamecmp);				// sunqueen modify
    return p ? *p : NULL;
}
