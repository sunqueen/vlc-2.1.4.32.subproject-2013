...
{
    vlc_object_t *dst = (vlc_object_t *)data;			// sunqueen modify
                                ...
                                const char *id, const char *name)
{
    ...
    if (name != NULL)
    {
        ...
        {
            dev = (aout_dev_t *)malloc (sizeof (*dev) + strlen (id));			// sunqueen modify
...
audio_output_t *aout_New (vlc_object_t *parent)
{
    ...
    audio_output_t *aout = (audio_output_t *)vlc_custom_create (parent, sizeof (aout_instance_t),			// sunqueen modify
                                              "audio output");
...
int aout_DevicesList (audio_output_t *aout, char ***ids, char ***names)
{
    ...
    tabid = (char **)xmalloc (sizeof (*tabid) * count);			// sunqueen modify
    tabname = (char **)xmalloc (sizeof (*tabname) * count);			// sunqueen modify
    *ids = tabid;
    *names = tabname;
