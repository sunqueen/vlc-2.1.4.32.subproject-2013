...
static void input_item_add_subitem_tree ( const vlc_event_t * p_event,
                                          void * user_data )
{
    input_item_t *p_input = (input_item_t *)p_event->p_obj;			// sunqueen modify
...
static void input_item_changed( const vlc_event_t * p_event,
                                void * user_data )
{
    playlist_item_t *p_item = (playlist_item_t *)user_data;			// sunqueen modify
    VLC_UNUSED( p_event );
...
{
    playlist_item_t* p_item = (playlist_item_t *)malloc( sizeof( playlist_item_t ) );			// sunqueen modify
    if( !p_item )
        return NULL;
