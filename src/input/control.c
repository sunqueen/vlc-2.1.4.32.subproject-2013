    ...
    switch( i_query )
    {
        ...
        case INPUT_GET_BOOKMARKS:
            ...
            if( p_input->p->i_bookmark )
            {
                ...
                *ppp_bkmk = (seekpoint_t **)malloc( sizeof(seekpoint_t *) *			// sunqueen modify
        ...
        case INPUT_GET_ATTACHMENTS: /* arg1=input_attachment_t***, arg2=int*  res=can fail */
        {
            ...
            *ppp_attachment = (input_attachment_t **)malloc( sizeof(input_attachment_t**) * p_input->p->i_attachment );			// sunqueen modify
...
static void UpdateBookmarksOption( input_thread_t *p_input )
{
    ...
    char *psz_value = (char *)malloc( i_len + p_input->p->i_bookmark + 1 );			// sunqueen modify
