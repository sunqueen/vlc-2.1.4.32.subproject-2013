...
{
   int (*activate) (vlc_object_t *) = (int (__cdecl *)(vlc_object_t *))m->pf_activate;			// sunqueen modify
...
{
   void (*deactivate) (vlc_object_t *) = (void (__cdecl *)(vlc_object_t *))m->pf_deactivate;			// sunqueen modify
...
static int generic_start(void *func, va_list ap)
{
    ...
    int (*activate)(vlc_object_t *) = (int (__cdecl *)(vlc_object_t *))func;			// sunqueen modify
...
{
    vlc_object_t *obj = va_arg(ap, vlc_object_t *);
    void (*deactivate)(vlc_object_t *) = (void (__cdecl *)(vlc_object_t *))func;			// sunqueen modify
...
module_config_t *module_config_get( const module_t *module, unsigned *restrict psize )
{
    ...
    module_config_t *config = (module_config_t *)malloc( size * sizeof( *config ) );			// sunqueen modify
