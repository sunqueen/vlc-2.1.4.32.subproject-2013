 ...
 * $Id: 8874e70382d5dbdecd17d6ccdf440160874b7291 $
 *
...
{
    int (*activate) (vlc_tls_creds_t *, const char *, const char *) = (int (__cdecl *)(vlc_tls_creds_t *,const char *,const char *))func;			// sunqueen modify
...
{
    int (*activate) (vlc_tls_creds_t *) = (int (__cdecl *)(vlc_tls_creds_t *))func;			// sunqueen modify
    vlc_tls_creds_t *crd = va_arg (ap, vlc_tls_creds_t *);
...
{
    void (*deactivate) (vlc_tls_creds_t *) = (void (__cdecl *)(vlc_tls_creds_t *))func;			// sunqueen modify
    vlc_tls_creds_t *crd = va_arg (ap, vlc_tls_creds_t *);
...
vlc_tls_ServerCreate (vlc_object_t *obj, const char *cert_path,
                      const char *key_path)
{
    vlc_tls_creds_t *srv = (vlc_tls_creds_t *)vlc_custom_create (obj, sizeof (*srv),			// sunqueen modify
                                              "tls server");
...
{
    vlc_tls_creds_t *crd = (vlc_tls_creds_t *)vlc_custom_create (obj, sizeof (*crd),			// sunqueen modify
                                              "tls client");
...
vlc_tls_t *vlc_tls_SessionCreate (vlc_tls_creds_t *crd, int fd,
                                  const char *host)
{
    vlc_tls_t *session = (vlc_tls_t *)vlc_custom_create (crd, sizeof (*session),			// sunqueen modify
                                            "tls session");
