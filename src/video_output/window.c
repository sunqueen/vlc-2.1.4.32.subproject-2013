...
{
    int (*activate)(vout_window_t *, const vout_window_cfg_t *) = (int (__cdecl *)(vout_window_t *,const vout_window_cfg_t *))func;			// sunqueen modify
...
{
    window_t *w = (window_t *)vlc_custom_create(obj, sizeof(*w), "window");			// sunqueen modify
...
{
    int (*deactivate)(vout_window_t *) = (int (__cdecl *)(vout_window_t *))func;			// sunqueen modify
    vout_window_t *wnd = va_arg(ap, vout_window_t *);
