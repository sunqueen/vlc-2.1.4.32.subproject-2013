...
static int OpenDecoder( vlc_object_t *p_this )
{
    ...
    if( ( p_dec->p_sys = p_sys = (decoder_sys_t *)calloc( 1, sizeof(*p_sys)) ) == NULL )			// sunqueen modify
        return VLC_ENOMEM;
    ...
    while( 1 )
    {
        ...
        case STATE_GOP:
            ...
            if( p_sys->p_info->user_data_len > 2 )
            {
                ...
                p_sys->p_gop_user_data = (uint8_t *)calloc( p_sys->p_info->user_data_len, sizeof(uint8_t) );			// sunqueen modify
        ...
        case STATE_SLICE:
            ...
            {
                p_pic = (picture_t *)p_sys->p_info->display_fbuf->id;			// sunqueen modify
            ...
            {
                DpbUnlinkPicture( p_dec, (picture_t *)p_sys->p_info->discard_fbuf->id );			// sunqueen modify
            }
