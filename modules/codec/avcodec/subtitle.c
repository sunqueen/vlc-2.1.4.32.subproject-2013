 ...
 * $Id: 407bb90d93dd89997520e9eeaa7961a7ff418beb $
 *
                    ...
                    AVCodec *codec, int codec_id, const char *namecodec)
{
    ...
    /* */
    dec->p_sys = sys = (decoder_sys_t *)malloc(sizeof(*sys));			// sunqueen modify
    if (!sys)
        return VLC_ENOMEM;

    codec->type = AVMEDIA_TYPE_SUBTITLE;
    context->codec_type = AVMEDIA_TYPE_SUBTITLE;
    context->codec_id = (AVCodecID)codec_id;			// sunqueen modify
