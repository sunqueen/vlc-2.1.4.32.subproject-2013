                       ...
                       const video_format_t fmt, bool b_opaque, const int text_offset )
{
    ...
    for( y = 0; y < fmt.i_height; y++ )
    {
        ...
        {
            const vbi_opacity opacity = (const vbi_opacity)p_page.text[ text_offset + y/10 * p_page.columns + x/12 ].opacity;			// sunqueen modify
...
static int RequestPage( vlc_object_t *p_this, char const *psz_cmd,
                        vlc_value_t oldval, vlc_value_t newval, void *p_data )
{
    decoder_sys_t *p_sys = (decoder_sys_t *)p_data;			// sunqueen modify
...
static int EventKey( vlc_object_t *p_this, char const *psz_cmd,
                        vlc_value_t oldval, vlc_value_t newval, void *p_data )
{
    decoder_t *p_dec = (decoder_t *)p_data;			// sunqueen modify
    decoder_sys_t *p_sys = p_dec->p_sys;
