...
//        { {"title",        {.smpl = set_item_info}, false },
        { {"title",        {set_item_info}, false },
//          {"creator",      {.smpl = set_item_info}, false },
          {"creator",      {set_item_info}, false },
//          {"annotation",   {.smpl = set_item_info}, false },
          {"annotation",   {set_item_info}, false },
          {"info",         {NULL}, false },
          {"location",     {NULL}, false },
          {"identifier",   {NULL}, false },
//          {"image",        {.smpl = set_item_info}, false },
          {"image",        {set_item_info}, false },
          {"date",         {NULL}, false },
          {"license",      {NULL}, false },
//          {"attribution",  {.cmplx = skip_element}, true },
          {"attribution",  {(bool (__cdecl *)(input_item_t *,const char *,char *))skip_element}, true },
          {"link",         {NULL}, false },
          {"meta",         {NULL}, false },
//          {"extension",    {.cmplx = parse_extension_node}, true },
          {"extension",    {(bool (__cdecl *)(input_item_t *,const char *,char *))parse_extension_node}, true },
//          {"trackList",    {.cmplx = parse_tracklist_node}, true },
          {"trackList",    {(bool (__cdecl *)(input_item_t *,const char *,char *))parse_tracklist_node}, true },
        };
	// sunqueen modify end
...
//          {"info",         {.smpl = set_item_info}, false },
          {"info",         {set_item_info}, false },
//          {"image",        {.smpl = set_item_info}, false },
          {"image",        {set_item_info}, false },
//          {"album",        {.smpl = set_item_info}, false },
          {"album",        {set_item_info}, false },
//          {"trackNum",     {.smpl = set_item_info}, false },
          {"trackNum",     {set_item_info}, false },
//          {"duration",     {.smpl = set_item_info}, false },
          {"duration",     {set_item_info}, false },
          {"link",         {NULL}, false },
          {"meta",         {NULL}, false },
//          {"extension",    {.cmplx = parse_extension_node}, true },
          {"extension",    {(bool (__cdecl *)(input_item_t *,const char *,char *))parse_extension_node}, true },
    ...
    case XML_READER_ENDELEM:
        ...
        if (!strcmp(name, psz_element))
        {
            ...
            {
                input_item_t **pp;
                pp = (input_item_t **)realloc(p_sys->pp_tracklist,			// sunqueen modify
...
//        { {"vlc:node",   {.cmplx = parse_extension_node}, true },
        { {"vlc:node",   {(bool (__cdecl *)(input_item_t *,const char *,char *))parse_extension_node}, true },
//          {"vlc:item",   {.cmplx = parse_extitem_node}, true },
          {"vlc:item",   {(bool (__cdecl *)(input_item_t *,const char *,char *))parse_extitem_node}, true },
          {"vlc:id",     {NULL}, false },
//          {"vlc:option", {.smpl = set_option}, false },
          {"vlc:option", {set_option}, false },
	// sunqueen modify end
        };
