...
static int Activate( vlc_object_t *p_this )
{
    ...
    intf_sys_t *p_sys = (intf_sys_t *)malloc( sizeof( *p_sys ) );			// sunqueen modify
...
{
    intf_thread_t *p_intf = (intf_thread_t *)data;			// sunqueen modify
    intf_sys_t *p_sys = p_intf->p_sys;
...
//#warning This is not reliable...			// sunqueen delete
        else if( p_sys->p_input->b_dead )
        {
            ...
            p_sys->i_last_state = (playlist_status_t)PLAYLIST_STOPPED;			// sunqueen modify
