...
// sunqueen move start
enum __sensor { HDAPS_SENSOR, AMS_SENSOR, APPLESMC_SENSOR,
       UNIMOTION_SENSOR } ;
// sunqueen move end
...
motion_sensors_t *motion_create( vlc_object_t *obj )
{
    ...
    motion_sensors_t *motion = (motion_sensors_t *)malloc( sizeof( motion_sensors_t ) );			// sunqueen modify
