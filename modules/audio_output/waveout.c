...
static int Start( audio_output_t *p_aout, audio_sample_format_t *restrict fmt )
{
    ...
    p_aout->sys->p_silence_buffer = (uint8_t *)			// sunqueen modify
                                 ...
                                 char ***values, char ***descs )
{
    ...
    *values = (char **)xmalloc( (nb_devices + 1) * sizeof(char *) );			// sunqueen modify
    *descs = (char **)xmalloc( (nb_devices + 1) * sizeof(char *) );			// sunqueen modify
