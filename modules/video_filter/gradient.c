                                             ...
                                             picture_t *p_outpic )
{
    ...
    int i_diag = sqrt( (double) (i_num_lines * i_num_lines +
                        i_src_visible * i_src_visible) );			// sunqueen modify
    ...
    int *p_hough = (int *)malloc( i_diag * i_nb_steps * sizeof(int) );			// sunqueen modify
    if( ! p_hough ) return;
    ...
    if( ! p_pre_hough )
    {
        ...
        p_pre_hough = (int *)malloc( i_num_lines*i_src_visible*i_nb_steps*sizeof(int));			// sunqueen modify
        if( ! p_pre_hough )
        {
            free( p_smooth );
            free( p_hough );
