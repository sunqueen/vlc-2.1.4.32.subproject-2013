 ...
 * $Id: 9088f32416e7c40bccd720f70f836fa428a3f106 $
 *
...
static int Activate( vlc_object_t *p_this )
{
    ...
    p_sys = p_filter->p_sys = (filter_sys_t *)calloc( 1, sizeof( *p_sys ) );			// sunqueen modify
    if( !p_sys )
        return VLC_ENOMEM;
...
static int BufferAllocationInit ( filter_t *p_filter, void *p_data )
{
    ...
    p_filter->p_owner = (filter_owner_sys_t *)p_data;			// sunqueen modify
    return VLC_SUCCESS;
}
