...
static int Create( vlc_object_t *p_this )
{
    ...
    /* Allocate structure */
    p_filter->p_sys = p_sys = (filter_sys_t *)malloc( sizeof( filter_sys_t ) );			// sunqueen modify
    ...
    p_sys->p_buf  = (uint32_t *)calloc( p_fmt->i_width * p_fmt->i_height, sizeof(*p_sys->p_buf) );			// sunqueen modify
    p_sys->p_buf2 = (uint32_t *)calloc( p_fmt->i_width * p_fmt->i_height, sizeof(*p_sys->p_buf) );			// sunqueen modify
