...
static int vlclua_xml_create( lua_State *L )
{
    ...
    xml_t **pp_xml = (xml_t **)lua_newuserdata( L, sizeof( xml_t * ) );			// sunqueen modify
    *pp_xml = p_xml;
...
static int vlclua_xml_create_reader( lua_State *L )
{
    ...
    xml_reader_t **pp_reader = (xml_reader_t **)lua_newuserdata( L, sizeof( xml_reader_t * ) );			// sunqueen modify
    *pp_reader = p_reader;
