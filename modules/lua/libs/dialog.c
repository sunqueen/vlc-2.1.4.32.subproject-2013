...
static int vlclua_dialog_create( lua_State *L )
{
    ...
    extension_dialog_t *p_dlg = (extension_dialog_t *)calloc( 1, sizeof( extension_dialog_t ) );			// sunqueen modify
    if( !p_dlg )
    ...
    extension_dialog_t **pp_dlg = (extension_dialog_t **)lua_newuserdata( L, sizeof( extension_dialog_t* ) );			// sunqueen modify
    *pp_dlg = p_dlg;
...
static int vlclua_dialog_add_button( lua_State *L )
{
    ...
    extension_widget_t *p_widget = (extension_widget_t *)calloc( 1, sizeof( extension_widget_t ) );			// sunqueen modify
...
static int vlclua_dialog_add_text_inner( lua_State *L, int i_type )
{
    ...
    extension_widget_t *p_widget = (extension_widget_t *)calloc( 1, sizeof( extension_widget_t ) );			// sunqueen modify
    p_widget->type = (extension_widget_type_e)i_type;			// sunqueen modify
    if( !lua_isnil( L, 2 ) )
        p_widget->psz_text = strdup( luaL_checkstring( L, 2 ) );
...
end_of_args:
    ...
    /* Create meta table */
    extension_widget_t **pp_widget = (extension_widget_t **)lua_newuserdata( L, sizeof( extension_widget_t* ) );			// sunqueen modify
    *pp_widget = p_widget;
...
static int vlclua_widget_add_value( lua_State *L )
{
    ...
    struct extension_widget_value_t *p_value,
        *p_new_value = (extension_widget_value_t *)calloc( 1, sizeof( struct extension_widget_value_t ) );			// sunqueen modify
