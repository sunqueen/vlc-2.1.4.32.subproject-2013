...
static int Activate( vlc_object_t *p_this )
{
...
#if defined (MODULE_NAME_IS_i420_rgb)
        case VLC_CODEC_RGB8:
            p_filter->p_sys->p_buffer = (uint8_t *)malloc( VOUT_MAX_WIDTH );			// sunqueen modify
            break;
#endif

        case VLC_CODEC_RGB15:
        case VLC_CODEC_RGB16:
            p_filter->p_sys->p_buffer = (uint8_t *)malloc( VOUT_MAX_WIDTH * 2 );			// sunqueen modify
            break;

        case VLC_CODEC_RGB24:
        case VLC_CODEC_RGB32:
            p_filter->p_sys->p_buffer = (uint8_t *)malloc( VOUT_MAX_WIDTH * 4 );			// sunqueen modify
            break;
    ...
    p_filter->p_sys->p_offset = (int *)malloc( p_filter->fmt_out.video.i_width			// sunqueen modify
