...
void bd_mpls_play_item_Parse( bd_mpls_play_item_t *p_item, bs_t *s )
{
    ...
    if( b_angle )
    {
        ...
        p_item->p_clpi = (bd_mpls_clpi_t *)calloc( i_angle, sizeof(*p_item->p_clpi) );			// sunqueen modify
    ...
    p_item->i_stream = 0;
    p_item->p_stream = (bd_mpls_stream_t *)calloc( i_video + i_audio + i_pg + i_ig,			// sunqueen modify
...
int bd_mpls_Parse( bd_mpls_t *p_mpls, bs_t *s, int i_id )
{
    ...
    p_mpls->p_play_item = (bd_mpls_play_item_t *)calloc( i_play_item, sizeof(*p_mpls->p_play_item) );			// sunqueen modify
    ...
    p_mpls->p_sub_path = (bd_mpls_sub_path_t *)calloc( i_sub_path, sizeof(*p_mpls->p_sub_path) );			// sunqueen modify
    ...
    p_mpls->p_mark = (bd_mpls_mark_t *)calloc( i_mark, sizeof(*p_mpls->p_mark) );			// sunqueen modify
