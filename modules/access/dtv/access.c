...
//static const delsys_t dvbc, dvbs, dvbs2, dvbt, dvbt2;			// sunqueen delete
static int dvbc_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t dvbc = { /*.setup =*/ dvbc_setup };			// sunqueen move
static int dvbs_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t dvbs = { /*.setup =*/ dvbs_setup };			// sunqueen move
static int dvbs2_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t dvbs2 = { /*.setup =*/ dvbs2_setup };			// sunqueen move
static int dvbt_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t dvbt = { /*.setup =*/ dvbt_setup };			// sunqueen move
static int dvbt2_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t dvbt2 = { /*.setup =*/ dvbt2_setup };			// sunqueen move
//static const delsys_t isdbc, isdbs, isdbt;			// sunqueen delete
static int isdbc_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t isdbc = { /*.setup =*/ isdbc_setup };			// sunqueen move
static int isdbs_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t isdbs = { /*.setup =*/ isdbs_setup };			// sunqueen move
static int isdbt_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t isdbt = { /*.setup =*/ isdbt_setup };			// sunqueen move
//static const delsys_t atsc, cqam;			// sunqueen delete
static int atsc_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t atsc = { /*.setup =*/ atsc_setup };			// sunqueen move
static int cqam_setup (vlc_object_t *obj, dvb_device_t *dev, uint64_t freq);			// sunqueen add
static const delsys_t cqam = { /*.setup =*/ cqam_setup };			// sunqueen move
...
static int Open (vlc_object_t *obj)
{
    ...
    access_sys_t *sys = (access_sys_t *)malloc (sizeof (*sys));			// sunqueen modify
...
{
    return strcasecmp ((const char *)a, *(const char *const *)b);			// sunqueen modify
}
...
static const char *var_InheritModulation (vlc_object_t *obj, const char *var)
{
    ...
    const char *const *p = (const char *const *)lfind (mod, modulation_vlc, &n, sizeof (mod), modcmp);			// sunqueen modify
    if (p != NULL)
    {
        free (mod);
        return *p;
...
//static const delsys_t atsc = { .setup = atsc_setup };			// sunqueen delete
...
//static const delsys_t cqam = { .setup = cqam_setup };			// sunqueen delete
...
//static const delsys_t dvbc = { .setup = dvbc_setup };			// sunqueen delete
...
//static const delsys_t dvbs = { .setup = dvbs_setup };			// sunqueen delete
//static const delsys_t dvbs2 = { .setup = dvbs2_setup };		// sunqueen delete
...
//static const delsys_t dvbt = { .setup = dvbt_setup };			// sunqueen delete
//static const delsys_t dvbt2 = { .setup = dvbt2_setup };		// sunqueen delete
...
//static const delsys_t isdbc = { .setup = isdbc_setup };			// sunqueen delete
...
//static const delsys_t isdbs = { .setup = isdbs_setup };			// sunqueen delete
...
//static const delsys_t isdbt = { .setup = isdbt_setup };			// sunqueen delete
