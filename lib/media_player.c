                        ...
                        void * p_userdata )
{
    ...
    VLC_UNUSED(p_this);
    VLC_UNUSED(psz_cmd);
    libvlc_media_player_t * p_mi = (libvlc_media_player_t *)p_userdata;			// sunqueen modify
                              ...
                              vlc_value_t oldval, vlc_value_t newval, void *p_data )
{
    ...
    libvlc_media_player_t *mp = (libvlc_media_player_t *)p_data;			// sunqueen modify
    libvlc_event_t event;
...
libvlc_media_player_new( libvlc_instance_t *instance )
{
    ...
    mp = (libvlc_media_player_t *)vlc_object_create (instance->p_libvlc_int, sizeof(*mp));			// sunqueen modify
    if (unlikely(mp == NULL))
    {
                                   ...
                                   unsigned navigate )
{
    static const vlc_action_t map[] =
    {
        ...
        (vlc_action_t)INPUT_NAV_ACTIVATE, (vlc_action_t)INPUT_NAV_UP, (vlc_action_t)INPUT_NAV_DOWN,
        (vlc_action_t)INPUT_NAV_LEFT, (vlc_action_t)INPUT_NAV_RIGHT,
		// sunqueen modify end
    };
