...
{
    VLC_UNUSED(p_event);
    libvlc_media_list_player_t * p_mlp = (libvlc_media_list_player_t *)p_user_data;			// sunqueen modify
...
libvlc_media_list_player_new(libvlc_instance_t * p_instance)
{
    ...
    p_mlp = (libvlc_media_list_player_t *)calloc( 1, sizeof(libvlc_media_list_player_t) );			// sunqueen modify
