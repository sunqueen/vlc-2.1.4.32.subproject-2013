...
libvlc_instance_t * libvlc_new( int argc, const char *const *argv )
{
    ...
    libvlc_instance_t *p_new = (libvlc_instance_t *)malloc (sizeof (*p_new));			// sunqueen modify
...
{
    vlc_sem_post( (vlc_sem_t *)data );			// sunqueen modify
}
...
extern "C" const char psz_vlc_changeset[];			// sunqueen modify
