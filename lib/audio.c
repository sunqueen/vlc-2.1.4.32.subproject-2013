 ...
 * $Id: d125f5e714a77da9adb37c4c3a915d12cd79f424 $
 *
        ...
        libvlc_audio_output_list_get( libvlc_instance_t *p_instance )
{
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        libvlc_audio_output_t *item = (libvlc_audio_output_t *)malloc( sizeof( *item ) );			// sunqueen modify
                                     ...
                                     const char *aout )
{
    ...
    {
        libvlc_audio_output_device_t *item = (libvlc_audio_output_device_t *)malloc( sizeof(*item) );			// sunqueen modify
        if( unlikely(item == NULL) )
            break;
